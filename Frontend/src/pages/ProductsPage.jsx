...
import { Box, Button, Divider, Flex, HStack, Heading, SimpleGrid, Spinner, Text, VStack, useColorModeValue } from "@chakra-ui/react"
...
export const ProductsPage = () => {
  ...
  ] = useProductsStore((state) => [state.isLoading, state.products, state.totalProducts], shallow)
